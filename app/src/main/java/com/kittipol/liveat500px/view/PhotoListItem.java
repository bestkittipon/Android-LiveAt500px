package com.kittipol.liveat500px.view;
...
public class PhotoListItem extends BaseCustomViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int NewHeightMeasureSpac = MeasureSpec.makeMeasureSpec(Height, MeasureSpec.EXACTLY);

        //Child View
        super.onMeasure(widthMeasureSpec, NewHeightMeasureSpac);
